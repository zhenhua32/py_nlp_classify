...
if __name__ == "__main__":
    ...
    for ep in range(1, EPOCHS + 1):
        ...
        for idx, (inputs, targets) in enumerate(tqdm(train_loader, disable=rank != 0)):
...
"""
python -m torch.distributed.launch --nproc_per_node=1 --nnodes=1 --node_rank=0 --master_addr=localhost --master_port=22222 ddp_train.py
usage:
